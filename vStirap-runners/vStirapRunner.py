...
class vStirap_3lvl_pol_decay_runner():
    ...
    def __init__(self,
        ...
        self.alpha_CL, self.phi1_CL, self.phi2_CL, self.beta_CL = R2args(self.R_CL)
        self.alpha_ML, self.phi1_ML, self.phi2_ML, self.beta_ML = R2args(self.R_ML)
        self.alpha_MC, self.phi1_MC, self.phi2_MC, self.beta_MC = R2args(self.R_MC)
        ...
        self.c_op_list = self.__configure_c_ops(self.alpha_MC, self.phi1_MC, self.phi2_MC, self.beta_MC,
                                                self.branching_ratios)

    def run(self, amp_drive, len_drive=1, n_steps=201, psi0 = ['gM',0,0]):
    ...
    def __configure_c_ops(self,
                    alpha_MC, beta_MC, phi1_MC, phi2_MC,
                    branching_ratios):
        # Define collapse operators
        c_op_list = []
        ...
        for kappa, aMX, aMY in zip([self.kappa1, self.kappa2], [aM1X, aM2X], [aM1Y, aM2Y]):
        ...
        self.args_hams.update({"deltaP":self.deltaP})
